...
public class JavaParser implements JavaParserConstants {
  ...
  final public ExplicitConstructorInvocation ExplicitConstructorInvocation() throws ParseException {
...

   {
    ...
    n21 = jj_consume_token(SEMICOLON);
             n20 = JTBToolkit.makeNodeToken(n21);
     {if (true) return new ExplicitConstructorInvocation(n0,n6,n12,n14,n19,n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public RUNSIGNEDSHIFT RUNSIGNEDSHIFT() throws ParseException {
...

   {
    ...
    if (getToken(1).kind == GT && ((Token)getToken(1)).kind == RUNSIGNEDSHIFT) {
    ...
    n5 = jj_consume_token(GT);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new RUNSIGNEDSHIFT(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public RSIGNEDSHIFT RSIGNEDSHIFT() throws ParseException {
...

   {
    ...
    if (getToken(1).kind == GT && ((Token)getToken(1)).kind == RSIGNEDSHIFT) {
    ...
    n3 = jj_consume_token(GT);
            n2 = JTBToolkit.makeNodeToken(n3);
     {if (true) return new RSIGNEDSHIFT(n0,n2);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private boolean jj_3R_74() {
    ...
    xsp = jj_scanpos;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == GT && ((Token)getToken(1)).kind == RSIGNEDSHIFT;
    lookingAhead = false;
  ...
  final private boolean jj_3R_75() {
    ...
    xsp = jj_scanpos;
    lookingAhead = true;
    jj_semLA = getToken(1).kind == GT && ((Token)getToken(1)).kind == RUNSIGNEDSHIFT;
    lookingAhead = false;
